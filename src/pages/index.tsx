...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Mutasiku`}</title>

        <meta
          name="description"
          content="Experience the power of unified banking with Mutasiku - your one-stop dashboard for multiple bank mutations, account balances, and seamless internet banking."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1579621970795-87facc2f976d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiYW5raW5nfGVufDB8fHx8MTY5Mzk0NTMyMHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of unified banking with Mutasiku - your one-stop dashboard for multiple bank mutations, account balances, and seamless internet banking.`}
            </Text>
            <Box
