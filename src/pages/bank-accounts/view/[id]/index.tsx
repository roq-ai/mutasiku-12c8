...
import { getBankAccountById } from 'apiSdk/bank-accounts';
import { BankAccountInterface } from 'interfaces/bank-account';
import { AccountBalanceListPage } from 'pages/account-balances';
import { MutationDataListPage } from 'pages/mutation-data';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('bank_account', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/bank-accounts/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Bank Name" text={data?.bank_name} />
